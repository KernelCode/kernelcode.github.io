...
function getNewCommandLine(){code=document.createElement("code");code.innerHTML='<code><div class="command_line" id="command_line"><span style="">0x01@<span style="color:#eee">HAL9000</span> <span style="color:#f55">#~</span></span><span id="command" style="color:#eee"></span><span id="ptr">|</span></div><span id="res-date" style="color:#777;font-size:8px"></span><span id="res" style="color:#7f7"></span><div style="display:none" id=\'thinking\'></div></code>  ';codesAry=document.getElementsByTagName("code");codesAry[codesAry.length-1].parentNode.insertBefore(code,codesAry[codesAry.length-1].nextSibling)}
